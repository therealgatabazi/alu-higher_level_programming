...
class Base:
    ...
    def to_json_string(list_dictionaries):
        """Convert dictionaries list to a JSON string"""
    ...
    def from_json_string(json_string):
        """Convert a JSON string to a dictionaries list"""
